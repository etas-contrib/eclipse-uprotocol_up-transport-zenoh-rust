...
This project is still in its inception phase, which is also reflected by major version `0` being used in all existing (pre-)releases.
Consequently, we only maintain the main branch of the repository and the most recent released version.
